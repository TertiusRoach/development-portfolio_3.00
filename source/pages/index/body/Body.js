    ...
    switch (blockName) {
        ...
        case 'default-body':
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement("header", { id: "".concat(pageName, "-header"), className: "".concat(block, "-header") },
                    react_1.default.createElement(Header_1.default, { pageName: "".concat(pageName, "-header"), blockName: "".concat(block, "-header") })),
                react_1.default.createElement("footer", { id: "".concat(pageName, "-footer"), className: "".concat(block, "-footer") },
                    react_1.default.createElement(Footer_1.default, { pageName: "".concat(pageName, "-footer"), blockName: "".concat(block, "-footer") })),
                react_1.default.createElement("aside", { id: "".concat(pageName, "-leftbar"), className: "".concat(block, "-leftbar") },
                    react_1.default.createElement(Leftbar_1.default, { pageName: "".concat(pageName, "-leftbar"), blockName: "".concat(block, "-leftbar") })),
                react_1.default.createElement("aside", { id: "".concat(pageName, "-rightbar"), className: "".concat(block, "-rightbar") },
                    react_1.default.createElement(Rightbar_1.default, { pageName: "".concat(pageName, "-rightbar"), blockName: "".concat(block, "-rightbar") })),
                react_1.default.createElement("main", { id: "".concat(pageName, "-main"), className: "".concat(block, "-main") },
